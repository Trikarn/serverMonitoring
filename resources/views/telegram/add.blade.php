        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">
                    {{ __('Добавление телеграмм-канала') }}
                </div>
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="POST" action="/telegram" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control @error('chat') is-invalid @enderror" value="{{ old('chat') }}" id="inputHost" name="chat">
                            @error('chat')
                              <span class="invalid-feedback" role="alert">
                                  <strong>{{ $message }}</strong>
                              </span>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-8">
                            <input type="text" class="form-control @error('token') is-invalid @enderror" value="{{ old('token') }}" id="inputHost" name="token">
                            @error('token')
                              <span class="invalid-feedback" role="alert">
                                  <strong>{{ $message }}</strong>
                              </span>
